...
-   Necesariamente explicable.

-   El producto es un modelo que explique comportamientos.
:::
::::::
...
::: {.columns style="font-size:20px"}
-   Las reglas son especialmente útiles en minería de datos, porqué te indicarán un camino o explicaciones del por qué de los outputs, dados tus inputs.

-   Recordar que no necesariamente coincidirá con lo esperado.

-   Lo anterior, este bien o mal, si funciona, sería buena idea usarlo de todas formas.

## Reglas de asociación

-   Responde a las preguntas: que tan frecuente es $Y$, dado alguna combinación de $X$. Por ejemplo, si el cliente compra pan, es posible que compre leche.

-   Se basa en if-then, donde `if es el antecedente` y `then es el consecuente`.

-   Usos comunes: tendencias en compras, detección de fraudes, sistemas de recomendación.

-   Algoritmos exclusivos: a priori, FP-growth, ECLAT.

-   Algoritmos compartidos con ML: redes neuronales, árboles de decisión.
